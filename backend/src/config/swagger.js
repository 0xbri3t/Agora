...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Agora DeFi Protocol API',
      version: '1.0.0',
      description: 'Backend API (TEE) for the Agora DeFi Protocol with real-time WebSocket support, limit/market orders, and comprehensive market data.'
    },
