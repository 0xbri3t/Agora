...
export const CONTRACTS = {
  ...
  31337: {
    PYUSD: (deployedAddresses as any)[31337]?.PYUSD as `0x${string}` || "0x0000000000000000000000000000000000000000" as const,
    PROPOSAL_MANAGER: (deployedAddresses as any)[31337]?.PROPOSAL_MANAGER as `0x${string}` || "0x0000000000000000000000000000000000000000" as const
  },
} as const;
